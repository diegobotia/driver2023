package com.udea.driver2023.service;

import com.udea.driver2023.dao.IFlightDAO;
import com.udea.driver2023.exception.FlightNotFoundException;
...
public class FlightService {
    ...
    public Flight save(Flight t) {return dao.save(t);}
//    public Driver update(Driver t) {return dao.save(t);}
    public String delete(long id) {dao.deleteById(id);  return "Flight removed";}
